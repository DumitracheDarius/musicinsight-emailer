...
function sendEmail({
  ...
  tiktok_csv_url
    ...
    <div style="font-family: Arial; padding: 20px;">
      ...
      <img src="${spotontrack_image_url}" style="max-width:600px; border-radius: 8px;" />

      <h3>📱 TikTok Performance</h3>
      <p>${chartex_stats}</p>
      <a href="${tiktok_csv_url}" download="TikTokPerformance.csv" style="display:inline-block;margin-top:8px;padding:8px 16px;background:#4a90e2;color:white;border-radius:6px;text-decoration:none;">
          Download TikTok CSV
      </a>

      <h3>📻 Radio Performance</h3>
      <img src="${mediaforest_image_url}" style="max-width:600px; border-radius: 8px;" />
